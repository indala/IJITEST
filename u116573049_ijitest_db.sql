...
VALUES (
        ...
        1,
        1,
        '/uploads/published/IJITEST-2026-001-published.pdf',
        1,
        7,
        NULL,
        '2026-03-28 09:00:00',
    ...
    (
        ...
        2,
        1,
        '/uploads/published/IJITEST-2026-002-published.pdf',
        8,
        12,
        NULL,
        '2026-03-29 10:00:00',
    ...
    (
        ...
        3,
        1,
        '/uploads/published/IJITEST-2026-003-published.pdf',
        13,
        20,
        NULL,
        '2026-03-29 11:00:00',
    ...
    (
        ...
        4,
        1,
        '/uploads/published/IJITEST-2026-004-published.pdf',
        21,
        26,
        NULL,
        '2026-03-30 12:00:00',
    ...
    (
        ...
        5,
        1,
        '/uploads/published/IJITEST-2026-005-published.pdf',
        27,
        32,
        NULL,
        '2026-03-31 13:00:00',
    ...
    (
        ...
        6,
        1,
        '/uploads/published/IJITEST-2026-006-published.pdf',
        33,
        37,
        NULL,
        '2026-03-31 14:00:00',
    ...
    (
        ...
        7,
        1,
        '/uploads/published/IJITEST-2026-007-published.pdf',
        38,
        41,
        NULL,
        '2026-03-31 15:00:00',
    ...
    (
        ...
        8,
        1,
        '/uploads/published/IJITEST-2026-008-published.pdf',
        42,
        45,
        NULL,
        '2026-03-31 16:00:00',
    ...
    (
        ...
        9,
        1,
        '/uploads/published/IJITEST-2026-009-published.pdf',
        46,
        49,
        NULL,
        '2026-03-31 17:00:00',
    ...
    (
        ...
        10,
        1,
        '/uploads/published/IJITEST-2026-010-published.pdf',
        50,
        53,
        NULL,
        '2026-03-31 18:00:00',
    ...
    (
        ...
        58,
        2,
        '/uploads/published/IJITEST-2026-011-published.pdf',
        NULL,
        NULL,
        NULL,
        '2026-05-02 07:21:24',
    ...
    (
        ...
        59,
        2,
        '/uploads/published/IJITEST-2026-012-published.pdf',
        NULL,
        NULL,
        NULL,
        '2026-05-02 07:21:24',
    ...
    (
        ...
        60,
        2,
        '/uploads/published/IJITEST-2026-013-published.pdf',
        NULL,
        NULL,
        NULL,
        '2026-05-02 07:21:24',
...
VALUES (
        'apcDescription',
        'APC covers DOI assignment, long-term hosting, indexing maintenance, and editorial handling. There are no submission or processing charges before acceptance.',
        '2026-05-13 17:54:00'
    ),
    (
        'apcInr',
    ...
    (
        'journalSubject',
        'Multidisciplinary (Engineering, Science and Technology, Healthcare, Management Sciences)',
        '2026-05-14 06:56:40'
    ),
    (
        'officeAddress',
...
VALUES (
        ...
        NULL,
        NULL,
        'ac34b85e-d7c0-454b-9ef9-4b73e39ee30a',
        1,
        '2026-03-28 09:00:00',
        '2026-04-19 05:41:03',
        NULL
    ...
    (
        ...
        NULL,
        NULL,
        'cd2ef493-3626-483a-93c6-8236287bf7a1',
        1,
        '2026-03-29 10:00:00',
        '2026-04-19 05:41:03',
        NULL
    ...
    (
        ...
        NULL,
        NULL,
        'ec6f9428-c3e0-4bdf-bb28-07ea86ba2440',
        1,
        '2026-03-31 14:00:00',
        '2026-04-19 05:41:03',
        NULL
    ...
    (
        ...
        NULL,
        NULL,
        'ec45d5c4-0ec8-49ff-a9c0-d18ea988bfb2',
        1,
        '2026-03-31 15:00:00',
        '2026-04-19 05:41:03',
        NULL
    ...
    (
        ...
        NULL,
        NULL,
        'fa60af47-276f-4c3a-8c34-89aae8ee28dd',
        1,
        '2026-03-31 16:00:00',
        '2026-04-19 05:41:03',
        NULL
    ...
    (
        ...
        NULL,
        NULL,
        'a0d1d251-cccd-4a52-93ff-26bcc7ae428a',
        1,
        '2026-03-31 17:00:00',
        '2026-04-19 05:41:03',
        NULL
    ...
    (
        ...
        NULL,
        NULL,
        'c411a1e8-1a94-4ba8-bf5c-d3bead1b617b',
        1,
        '2026-03-31 18:00:00',
        '2026-04-19 05:41:03',
        NULL
    ...
    (
        ...
        NULL,
        NULL,
        '9196f358-d1ce-448b-a854-4cc641684f97',
        2,
        '2026-05-02 07:21:24',
        '2026-05-02 07:21:24',
        NULL
    ...
    (
        ...
        NULL,
        NULL,
        '86bbe9e3-45f7-11f1-ad3e-c05465fbbdc2',
        2,
        '2026-05-02 07:21:24',
        '2026-05-02 07:21:24',
        NULL
...
VALUES (
        1,
        1,
        'Gulshan Sribabu Thorlapati',
        'gulshansribabu@gmail.com',
        1,
        0,
        NULL,
        NULL,
        'Department of CIVIL, Vignans Institute of Information Technology (A), Visakhapatnam, India'
    ),
    (
        2,
        1,
        'Chekatla Swapna Priya',
        'swapnachsp@gmail.com',
        0,
        1,
        NULL,
        NULL,
        'Department of CSE, Vignans Institute of Information Technology (A), Visakhapatnam, India'
    ),
    (
        3,
        1,
        'Suseela Kocho',
        'jackbenison12@gmail.com',
        0,
        2,
        NULL,
        NULL,
        'SGT, Department of school education, India'
    ),
    (
        4,
        2,
        'CheekatlaSwapna Priya',
        'swapnachsp@gmail.com',
        1,
        0,
        NULL,
        NULL,
        'Associate Professor,Department of CSE, Vignans Institute of Information Technology (A), Visakhapatnam, India'
    ),
    (
        5,
        3,
        'Swapna Priya Chikatla',
        'swapnachsp@gmail.com',
        1,
        0,
        NULL,
    ...
    (
        6,
        3,
        'Thorlapati Gulshan Sri Babu',
        'gulshansribabu@gmail.com',
        0,
        1,
        NULL,
        NULL,
        'Student,Department of CIVIL, Vignans Institute of Information Technology (A), Visakhapatnam, India'
    ),
    (
        7,
        3,
        'S Naga Mallik Raj',
        'mallikblue@gmail.com',
        0,
        2,
        NULL,
        NULL,
    ...
    (
        ...
        4,
        'Mahendra Narla',
        'nmahendra@gpcet.ac.in',
        0,
        1,
        NULL,
        NULL,
        'Associate Professor,Department of AI&DS, G.Pullaiah College of Engineering and Technology, Kurnool, India'
    ),
    (
        10,
        4,
        'PSN Bhashar',
        'bhaskarpsn@gmail.com',
        0,
        2,
        NULL,
        NULL,
        'Assistant Professor,Department of ECE, SVP Engineering College, Visakhapatnam, India'
    ),
    (
        11,
        5,
    ...
    (
        ...
        5,
        'CH. Subba Rao',
        'subbaraochappa@gmail.com',
        0,
        3,
        NULL,
        NULL,
        'Associate Professor,Department of ECE, Miracle Educational Society Group of Institutions(A), Vizianagaram, India'
    ),
    (
        15,
        6,
    ...
    (
        16,
        7,
        'S. Sai Durga Jagan Mohan',
        'missing_email_ijitest-2026-007_32ad464c@ijitest.org',
        1,
        0,
        NULL,
        NULL,
        'Department of Mechanical Engineering,Avanthi Institute of Engineering and Technology, Vizianagaram, A.P., India'
    ),
    (
        17,
        7,
        'P. Dinesh',
        'coauthor_17@ijitest.org',
        0,
        1,
        NULL,
        NULL,
    ...
    (
        19,
        7,
        'N. Lakshmi Vara Prasad',
        'coauthor_19@ijitest.org',
        0,
        3,
        NULL,
        NULL,
    ...
    (
        ...
        8,
        'S.HarshaVardhan',
        'harshavardhansingani@gmail.com',
        0,
        1,
        NULL,
        NULL,
    ...
    (
        ...
        8,
        'V.Jayakrishna',
        'jayakrishnavantakula@gmail.com',
        0,
        3,
        NULL,
        NULL,
    ...
    (
        ...
        8,
        'V.Pradeep Kumar',
        'pradeepvommi@gmail.com',
        0,
        5,
        NULL,
        NULL,
        'Associate Professor,Department of Mechanical Engineering,Avanthi Institute of Engineering and Technology, Vizianagaram, A.P., India'
    ),
    (
        27,
        9,
        'S D. Jagadeesh',
        'jagadishdunna2005@gmail.com',
        1,
        0,
        NULL,
        NULL,
    ...
    (
        ...
        9,
        'K.K.R. Parimala',
        'radhikaparimala325@gmail.com',
        0,
        5,
        NULL,
        NULL,
        'Assistant Professor,Department of Mechanical Engineering,Avanthi Institute of Engineering and Technology, Vizianagaram, A.P., India'
    ),
    (
        33,
        10,
        'Laharadithya',
        'missing_email_ijitest-2026-010_c5545a38@ijitest.org',
        1,
        0,
        NULL,
        NULL,
    ...
    (
        ...
        NULL,
        NULL,
        'Assistant Professor, Department of BS&H, Vignans Institute of Information Technology (A), Visakhapatnam, India'
    ),
    (
        47,
        6,
        'A. Venkateswara Rao',
        'vallu@miracleeducationalsociety.com',
        0,
        1,
        NULL,
        NULL,
    ...
    (
        ...
        6,
        'CH. Subba Rao',
        'schappa@miracleeducationalsociety.com',
        0,
        2,
        NULL,
        NULL,
        'Assistant Professor, Department of ECE, Miracle Educational Society Group of Institutions(A), Vizianagaram, India'
    ),
    (
        54,
        58,
        ...
        NULL,
        'Associate Professor',
        'Department of CSE, Vignan’s Institute of Information Technology (A), Visakhapatnam'
    ),
    (
        55,
        58,
        'Nadiminti Raghavendra',
        'raghavnadiminti@gmail.com',
        0,
        1,
        NULL,
    ...
    (
        ...
        59,
        'Markandeya Gupta N',
        'manasamarkandeya@gmail.com',
        1,
        0,
        NULL,
        'Associate Professor',
        'Department of ECE, Sri Sivani college of engineering (A), Srikakulam, India'
    ),
    (
        58,
        59,
        ...
        NULL,
        'Associate Professor',
        'Department of ECE, Gayatri Vidya Parishad college for Degree and PG Courses (A), Visakhapatnam, India'
    ),
    (
        59,
        59,
    ...
    (
        62,
        60,
        'Bharath Karthik Mycherla',
        'bharathkarthik2006@gmail.com',
        0,
        2,
        NULL,
        'Final-year B.Tech Student',
    ...
    (
        63,
        60,
        'Surya Teja Medisetty',
        'suryatejamedisetty000@gmail.com',
        0,
        3,
        NULL,
        'Final-year B.Tech Student',
...
VALUES (
    ...
    (
        ...
        '',
        '/uploads/published/IJITEST-2026-011-published.pdf',
        'IJITEST-2026-011-published.pdf',
        NULL,
        '2026-05-02 07:21:24'
    ),
    (
        ...
        '',
        '/uploads/published/IJITEST-2026-012-published.pdf',
        'IJITEST-2026-012-published.pdf',
        NULL,
        '2026-05-02 07:21:24'
    ),
    (
        ...
        '',
        '/uploads/published/IJITEST-2026-013-published.pdf',
        'IJITEST-2026-013-published.pdf',
        NULL,
        '2026-05-02 07:21:24'
    );
...
VALUES (
    ...
    (
        ...
        2,
        1,
        'Optimization and Performance Evaluation of RIS-Integrated Hybrid Precoding in Millimeter Wave Massive MIMO',
        ...
        '[\"Reconfigurable\", \"Intelligent Surfaces\", \"mmWave Massive MIMO systems\", \"Precoders\", \"RIS phase shifters\"]',
        'Engineering',
        NULL,
        '2026-03-29 10:00:00'
    ),
    (
        ...
        3,
        1,
        'Quantum-Enabled Security Framework for 6G Communications Based on QKD-OFDM Integration',
    ...
    (
        ...
        4,
        1,
        'RNN and CNNEnhanced EM-GAMP for Sparse Channel Estimation via Quantum Compressed Sensing in Massive MIMO-OFDM',
        ...
        '[\"Quantum Compressed Sensing\", \"OMP-based methods\", \"sparse recovery techniques\", \"compressed sensing\"]',
        'Engineering',
        NULL,
        '2026-03-30 12:00:00'
    ),
    (
        ...
        5,
        1,
        'Energy-Efficient Ternary Logic Processor Using CNTFETs for Advanced Nanotechnology Applications',
        ...
        '[\"Ternary Logic Processor\", \"CNTFET\", \"Low-Power Computing\", \"Nanotechnology\", \"Energy-Efficient Architecture\"]',
        'Engineering',
        NULL,
        '2026-03-31 13:00:00'
    ),
    (
        ...
        6,
        1,
        'Quantum Communication for 5G-6G Qubit-Driven Massive MIMO-OFDM Performance Analysis',
        ...
        '[\"Quantum Communication\", \"Qubits and Binary Bits\", \"Massive MIMO-OFDM\", \" 5G and 6G Networks\", \"Bit Error Rate\", \"Channel Estimation\"]',
        'Engineering',
        NULL,
        '2026-03-31 14:00:00'
    ),
    (
        ...
        7,
        1,
        'Fabrication of Multipurpose Agriculture Machine',
        'Agriculture plays a vital role in economic development, and modern technology integration is essential for improving productivity. This paper presents the fabrication of a multipurpose agricultural machine that performs spraying, seeding, and plowing operations using solar power as the primary energy source. The system reduces manual labor, minimizes fuel consumption, and promotes eco-friendly farming. The machine consists of a solar panel, battery storage, DC motors, and mechanical assemblies for three agricultural tasks: uniform pesticide spraying, controlled seed placement at proper depth and spacing, and soil plowing for aeration. Testing on a 100 sq.m test plot demonstrates 90% spraying uniformity, 88% seed placement accuracy at 15cm spacing, plowing depth of 10cm in medium soil, and 3 hours continuous operation on solar charge, achieving 70% labor reduction and 55% cost savings compared to manual farming methods',
        '[\"Agriculture Machine\", \"Solar Power\", \"Multipurpose\", \"Spraying\", \"Seeding\", \"Plowing\", \"DC Motor\", \"Renewable Energy\"]',
        'Engineering',
        NULL,
        '2026-03-31 15:00:00'
    ),
    ...
    (
        ...
        59,
        1,
        'Hybrid Quantum Machine Learning and Quantum Compressed Sensing for Robust Channel Estimation in Massive MIMO-OFDM Systems',
        ...
        '[\"Quantum Machine Learning (QML)\", \"Quantum Compressed Sensing (QCS)\", \"Massive MIMO-OFDM\", \"Channel Estimation\", \"6G Communication\", \"Sparse Signal Recovery\"]',
        NULL,
        NULL,
        '2026-05-02 07:21:24'
    ),
    (
        ...
        '[\"Deep Reinforcement Learning\", \"Proximal Policy Optimization (PPO)\", \"Edge Computing\", \"Dynamic Resource Allocation\", \"Markov Decision Process\", \"UAV Networks\", \"Energy Efficiency\", \"SLA Compliance\"]',
        NULL,
        NULL,
        '2026-05-02 07:21:24'
    );
...
VALUES (
        '02d01172-bb6f-4227-b980-f4abe1bd64ff',
        'radhikaparimala325@gmail.com',
        '$2a$10$7RmsVl.z6.v6jW9Vd1vU8.OsqYf4A5U5u5u5u5u5u5u5u5u5u5u',
        'author',
        1,
        0,
        NULL,
    ...
    (
        '29c83ca4-8361-4315-aa52-1628b3c38e22',
        'kongarapunaveen866@gmail.com',
        '$2a$10$7RmsVl.z6.v6jW9Vd1vU8.OsqYf4A5U5u5u5u5u5u5u5u5u5u5u',
        'author',
        1,
    ...
    (
        '41a2a42d-a5ce-4540-a8b2-ed1cbca451f6',
        'pradeepvommi@gmail.com',
        '$2a$10$7RmsVl.z6.v6jW9Vd1vU8.OsqYf4A5U5u5u5u5u5u5u5u5u5u5u',
        'author',
        1,
    ...
    (
        '4ea6669a-41b9-4f80-9be4-829a156f9089',
        'nmahendra@gpcet.ac.in',
        '$2a$10$7RmsVl.z6.v6jW9Vd1vU8.OsqYf4A5U5u5u5u5u5u5u5u5u5u5u',
        'author',
        1,
    ...
    (
        '5afb6ea1-45f9-4d45-b023-4e3e6c1fb025',
        'harshavardhansingani@gmail.com',
        '$2a$10$7RmsVl.z6.v6jW9Vd1vU8.OsqYf4A5U5u5u5u5u5u5u5u5u5u5u',
        'author',
        1,
    ...
    (
        '5d1f1b23-01bf-422b-9a83-a84d09249a85',
        'jayakrishnavantakula@gmail.com',
        '$2a$10$7RmsVl.z6.v6jW9Vd1vU8.OsqYf4A5U5u5u5u5u5u5u5u5u5u5u',
        'author',
        1,
    ...
    (
        '5e46659a-9c4d-4740-811d-ce905ef103d0',
        'bhaskarpsn@gmail.com',
        '$2a$10$7RmsVl.z6.v6jW9Vd1vU8.OsqYf4A5U5u5u5u5u5u5u5u5u5u5u',
        'author',
        1,
    ...
    (
        '79dbcba4-31c1-11f1-ad3e-c05465fbbdc2',
        'indalamohankumar21@gmail.com',
        '$2b$10$m6iHhngwesUoMWr/iPAuaepnWyTSiWv7ubOwAnVl0jwdzHdiICDAa',
        'editor',
        1,
        0,
        NULL,
    ...
    (
        '79dc1011-31c1-11f1-ad3e-c05465fbbdc2',
        'razh1976@gmail.com',
        '$2b$10$82mvRvTC4qGrcZWaIxe37eAvSGyfLNu45aKuiogg29q1NRLGZgMRa',
        'reviewer',
        1,
        0,
        NULL,
    ...
    (
        '79dc7b1c-31c1-11f1-ad3e-c05465fbbdc2',
        'somasekhar.ece@anits.edu.in',
        '$2b$10$p83k/rGRp24YN44Uao3xFeLoYFHfEZna9pY8sg5qdq2jShzvXRK/W',
        'reviewer',
        1,
        0,
        NULL,
    ...
    (
        '79dcbb44-31c1-11f1-ad3e-c05465fbbdc2',
        'manohar@gvpcdpgc.edu.in',
        '$2b$10$AD6WPbFIDVEoOoPZUCZAfeHqZ4YoQjexBjQOO6.3bDReU30H20AFK',
        'reviewer',
        1,
        0,
        NULL,
    ...
    (
        '79dcf791-31c1-11f1-ad3e-c05465fbbdc2',
        'venkatesh15793@gmail.com',
        '$2b$10$vCuOl9r0XinmX3pezxSBqOLGzBD3P5UgMh/D1XZWyDdtnisNaDmtK',
        'reviewer',
        1,
        0,
        NULL,
    ...
    (
        '79dd80d7-31c1-11f1-ad3e-c05465fbbdc2',
        'skaredla@gitam.edu',
        NULL,
        'reviewer',
        1,
    ...
    (
        '79de0a1f-31c1-11f1-ad3e-c05465fbbdc2',
        'norsuzila@salam.uitm.edu.my',
        '$2b$10$SoJp3xko/HImNINIVY2RjO9Vk17ERTTcijrIXECZ.f1/2EtiEwZfm',
        'editor',
        1,
        0,
        NULL,
    ...
    (
        '79de63c3-31c1-11f1-ad3e-c05465fbbdc2',
        'razh1977@gmail.com',
        NULL,
        'editor',
        1,
    ...
    (
        '79df667a-31c1-11f1-ad3e-c05465fbbdc2',
        'trinadhphd33@gmail.com',
        NULL,
        'editor',
        1,
        0,
    ...
    (
        '79dfcee0-31c1-11f1-ad3e-c05465fbbdc2',
        'mr.challa33@gmail.com',
        NULL,
        'editor',
        1,
        0,
    ...
    (
        '82b7987d-f90d-4a19-b1d3-1947671914db',
        'telukarthik9@gmail.com',
        '$2a$10$7RmsVl.z6.v6jW9Vd1vU8.OsqYf4A5U5u5u5u5u5u5u5u5u5u5u',
        'author',
        1,
    ...
    (
        '866d93bc-b280-4bc0-a776-ce70477630df',
        'jeevankumarkella@gmail.com',
        '$2a$10$7RmsVl.z6.v6jW9Vd1vU8.OsqYf4A5U5u5u5u5u5u5u5u5u5u5u',
        'author',
        1,
    ...
    (
        '86b68318-45f7-11f1-ad3e-c05465fbbdc2',
        'raghavnadiminti@gmail.com',
        '$2a$10$7RmsVl.z6.v6jW9Vd1vU8.OsqYf4A5U5u5u5u5u5u5u5u5u5u5u',
        'author',
        1,
    ...
    (
        '86b9b0e9-45f7-11f1-ad3e-c05465fbbdc2',
        'mallamohith20@gmail.com',
        '$2a$10$7RmsVl.z6.v6jW9Vd1vU8.OsqYf4A5U5u5u5u5u5u5u5u5u5u5u',
        'author',
        1,
    ...
    (
        '86be333a-45f7-11f1-ad3e-c05465fbbdc2',
        'vmn90gvd@gmail.com',
        '$2a$10$7RmsVl.z6.v6jW9Vd1vU8.OsqYf4A5U5u5u5u5u5u5u5u5u5u5u',
        'author',
        1,
    ...
    (
        '86c035ab-45f7-11f1-ad3e-c05465fbbdc2',
        'mdjani1209@gmail.com',
        '$2a$10$7RmsVl.z6.v6jW9Vd1vU8.OsqYf4A5U5u5u5u5u5u5u5u5u5u5u',
        'author',
        1,
    ...
    (
        '86c2652d-45f7-11f1-ad3e-c05465fbbdc2',
        'bharathkarthik2006@gmail.com',
        '$2a$10$7RmsVl.z6.v6jW9Vd1vU8.OsqYf4A5U5u5u5u5u5u5u5u5u5u5u',
        'author',
        1,
    ...
    (
        '86c50c19-45f7-11f1-ad3e-c05465fbbdc2',
        'suryatejamedisetty000@gmail.com',
        '$2a$10$7RmsVl.z6.v6jW9Vd1vU8.OsqYf4A5U5u5u5u5u5u5u5u5u5u5u',
        'author',
        1,
    ...
    (
        '86c79e83-45f7-11f1-ad3e-c05465fbbdc2',
        'pkalpana1109@gmail.com',
        '$2a$10$7RmsVl.z6.v6jW9Vd1vU8.OsqYf4A5U5u5u5u5u5u5u5u5u5u5u',
        'author',
        1,
    ...
    (
        '87b55eae-e296-4a65-a82f-3c503beadf7e',
        'editor@ijitest.org',
        '$2b$10$HpElpKNYCXaqdUpivIxWA.CLDniLlVW/GIb7VyiDv4Syl3WsKsdqy',
        'admin',
        1,
        0,
        NULL,
    ...
    (
        '94a51dbe-acc8-4df8-a3c6-03ecc15287a0',
        'subbaraochappa@gmail.com',
        '$2a$12$M2tKWAune7p18LlnZgnfkecIDlaQvQ6SkhDYrbMiX.9fOAPFpqYVy',
        'reviewer',
        1,
        1,
        NULL,
    ...
    (
        'ac34b85e-d7c0-454b-9ef9-4b73e39ee30a',
        'gulshansribabu@gmail.com',
        '$2a$12$XMa6PiA6G0OIOUFRuwnA..cADNcHYX61xvBHtNeHHPqfIgM3LXoKC',
        'author',
        1,
        0,
        NULL,
    ...
    (
        'af963fdb-af8a-4687-b843-dc604df4ff1c',
        'jackbenison12@gmail.com',
        '$2a$10$7RmsVl.z6.v6jW9Vd1vU8.OsqYf4A5U5u5u5u5u5u5u5u5u5u5u',
        'reviewer',
        1,
    ...
    (
        'bce1657c-32a6-492d-9df5-a03dcb465726',
        'indalamohankumar@gmail.com',
        '$2b$10$2nF2wRdIXIfGGFeFYJHYtOhuyufINNFC/pvZr/bAftSh6l4mql3H2',
        'reviewer',
        1,
        0,
        NULL,
    ...
    (
        'cd2ef493-3626-483a-93c6-8236287bf7a1',
        'swapnachsp@gmail.com',
        '$2b$10$S3VJhjb7uats5M8.eKctHeoiu2fIDsZfvimEDmMTOY8UFMoiFh12m',
        'editor',
        1,
        0,
        NULL,
    ...
    (
        'e3052d0b-2a66-462a-8541-bda5c7c09f6d',
        'pallavenkat11@gmail.com',
        '$2a$10$7RmsVl.z6.v6jW9Vd1vU8.OsqYf4A5U5u5u5u5u5u5u5u5u5u5u',
        'author',
        1,
    ...
    (
        'f7905eac-6c28-4718-a00f-3fe9849bc465',
        'saikumarbolla31@gmail.com',
        '$2a$10$7RmsVl.z6.v6jW9Vd1vU8.OsqYf4A5U5u5u5u5u5u5u5u5u5u5u',
        'author',
        1,
    ...
    (
        'f83fee8d-5304-4b40-806d-59531ed01db5',
        'neelapuabhiram007@gmail.com',
        '$2a$10$7RmsVl.z6.v6jW9Vd1vU8.OsqYf4A5U5u5u5u5u5u5u5u5u5u5u',
        'author',
        1,
    ...
    (
        'u19-mahendra-uuid-003',
        'narlamahendracai@gpcet.ac.in',
        '$2a$12$M2tKWAune7p18LlnZgnfkecIDlaQvQ6SkhDYrbMiX.9fOAPFpqYVy',
        'reviewer',
        1,
        1,
...
VALUES (
        ...
        'skaredla@gitam.edu',
        'editor',
        '09de0294e967aeb6a30abfeda5a51c62340e2d9aeb8a20b4e1143bdd46f95c3d',
        '2026-03-04 14:08:13',
        NULL,
        '2026-03-03 14:08:13'
    ),
    (
        ...
        'jackbenison12@gmail.com',
        'editor',
        'c606a2bab40b8cdae84258591cbd5da5e7fd771750d5ee06337519e2abb54438',
        '2026-03-04 14:09:25',
        NULL,
        '2026-03-03 14:09:25'
    ),
    (
        ...
        'razh1977@gmail.com',
        'editor',
        'a52772afc7c330f652056cdb27b926b8a7de3476dbb421a69981f3d2cc2d28b2',
        '2026-03-31 08:51:10',
        NULL,
        '2026-03-03 15:34:37'
    ),
    (
        ...
        'trinadhphd33@gmail.com',
        'editor',
        '46a219ab8c1a6157080a9886c7342c574ce6595408da12cdbcdb637f4cf53088',
        '2026-03-06 15:56:46',
        NULL,
        '2026-03-05 15:56:46'
    ),
    (
        ...
        'mr.challa33@gmail.com',
        'reviewer',
        '2f0d0f6f1068bb271034e7e22878c5660fa2e090e756ff31d6d898c5f73b8b52',
        '2026-03-06 15:56:53',
        NULL,
        '2026-03-05 15:56:53'
    ),
    (
        ...
        'norsuzila@salam.uitm.edu.my',
        'editor',
        '19f0fa58b5f10f5eea3a9c89de079d37af5b0278db54e25424b9d70145930d3a',
        '2026-05-06 09:32:59',
        NULL,
        '2026-05-06 08:32:59'
    );
...
VALUES (
    ...
    (
        ...
        'Dr. Ravibabu T.',
        'Associate Professor',
        'Department of Electronics and Communication Engineering, MES Group of Institutions',
        '+918919643590',
        '',
        'India',
        NULL,
    ...
    (
        25,
        '79de0a1f-31c1-11f1-ad3e-c05465fbbdc2',
        'Dr. Norsuzila Ya\'acob',
        'Professor',
        'Dept. of Electrical Engineering, University of Teknologi MARA, Shah Alam, Malaysia',
        NULL,
        NULL,
        'Malaysia',
        NULL,
    ...
    (
        ...
        'Dr. Mahendra Narla',
        'Associate Professor',
        'Dept of Artificial Intelligence and Data Science, GPCET, Kurnool, India',
        NULL,
        NULL,
        'India',
        NULL,
    ...
    (
        28,
        '79df667a-31c1-11f1-ad3e-c05465fbbdc2',
        'Dr. Trinadha Rao Challa',
        'Associate Professor',
        'Dept of Mechanical Engineering, MES Group of Institutions, India',
        NULL,
        NULL,
        'India',
        NULL,
    ...
    (
        31,
        '79dd80d7-31c1-11f1-ad3e-c05465fbbdc2',
        'Dr. Srinivasa Rao Thammada',
        'Professor',
        'Dept of Computer Science Engineering, GITAM University, India',
        NULL,
        NULL,
        'India',
        NULL,
...
INSERT INTO
    `_user_id_mapping` (`old_id`, `new_uuid`, `email`)
VALUES (
        1,
        '79daefad-31c1-11f1-ad3e-c05465fbbdc2',
        'editor@ijitest.org'
    ),
    (
        2,
        '79db5a7a-31c1-11f1-ad3e-c05465fbbdc2',
        'indalamohankumar@gmail.com'
    ),
    (
        3,
    ...
    (
        12,
        '79dd4a83-31c1-11f1-ad3e-c05465fbbdc2',
        'swapnachsp@gmail.com'
    ),
    (
        13,
    ...
    (
        17,
        '79ddcf7f-31c1-11f1-ad3e-c05465fbbdc2',
        'jackbenison12@gmail.com'
    ),
    (
        22,
...
ADD PRIMARY KEY (`id`),
ADD UNIQUE KEY `unique_assignment` (
    `submission_id`,
    `reviewer_id`,
    `version_id`,
    `review_round`
...
ADD PRIMARY KEY (`id`),
ADD UNIQUE KEY `submission_version_unique` (
    `submission_id`,
    `version_number`
);
...
--
ALTER TABLE `_user_id_mapping` ADD PRIMARY KEY (`old_id`);

--
-- Indexes for table `__drizzle_migrations`
--
ALTER TABLE `__drizzle_migrations` ADD PRIMARY KEY (`id`);
