            ...
            <div
                ...
                className={`
                    ...
                    ${fileName
                        ...
                        : 'border-primary/10 bg-primary/5 hover:border-secondary/30 hover:bg-primary/10'
                    }
                `}
            >
                <input
                ...
                <div className="flex items-center gap-4 relative z-10">
                    ...
                    <div className="flex-1 min-w-0">
                        <p className={`text-sm font-black truncate ${fileName ? 'text-emerald-700' : 'text-primary'}`}>
...
export default function ReviewerApplicationForm() {
    ...
    if (state?.success) {
        return (
            <motion.div
                ...
                className="bg-white rounded-[3rem] p-12 shadow-xl border border-primary/5 text-center overflow-hidden relative"
            >
                ...
                <div className="relative z-10">
                    ...
                    <h2 className="text-4xl font-black text-primary tracking-tighter mb-4">Transmission <span className="text-secondary">Confirmed</span></h2>
                    <p className="text-primary/60 font-medium text-lg mb-10 max-w-md mx-auto">
                        {activeTab === 'reviewer'
                    ...
                    <div className="p-8 bg-primary/5 rounded-[2rem] border border-primary/5 inline-block text-left shadow-inner">
                        <Badge variant="secondary" className="text-[9px] font-black uppercase tracking-[0.3em] bg-white text-primary px-3 h-6 mb-4">Next Protocol Steps</Badge>
                        <ul className="space-y-4 text-[10px] font-black uppercase tracking-[0.15em] text-primary/60">
    ...
    return (
        <div className="bg-white rounded-[3rem] shadow-xl border border-primary/5 overflow-hidden">
            <div className="bg-gradient-to-br from-primary via-primary to-primary/80 p-8 md:p-14 text-white relative overflow-hidden">
                <div className="absolute top-0 right-0 p-8 text-white/10 pointer-events-none">
                    <FileText className="w-32 h-32 md:w-48 md:h-48 opacity-10" />
                </div>
                <Badge variant="secondary" className="font-black text-[8px] md:text-[9px] uppercase tracking-[0.4em] bg-white/10 text-white border-white/20 px-4 h-7 rounded-full shadow-sm mb-4">Recruitment Protocol</Badge>
                <div className="relative z-10 space-y-2">
                    <h2 className="text-3xl md:text-5xl font-black tracking-tighter leading-tight">
                        Join the <span className="text-secondary block md:inline">Elite</span>
                    </h2>
                    <p className="text-xl md:text-3xl font-black text-white/40 tracking-tighter -mt-2">
                        {activeTab === 'reviewer' ? 'Review Board' : 'Editorial Panel'}
                    </p>
                </div>
            </div>

            <div className="p-6 md:p-14 pt-0">
                <Tabs value={activeTab} onValueChange={(v) => setActiveTab(v as any)} className="w-full -mt-6">
                    <TabsList className="w-full h-14 bg-white shadow-lg rounded-2xl border border-primary/5 p-1 gap-2">
                        <TabsTrigger value="reviewer" className="flex-1 h-full rounded-xl text-xs font-black uppercase tracking-widest data-[state=active]:bg-primary data-[state=active]:text-white transition-all">Review Board</TabsTrigger>
                        <TabsTrigger value="editor" className="flex-1 h-full rounded-xl text-xs font-black uppercase tracking-widest data-[state=active]:bg-primary data-[state=active]:text-white transition-all">Editorial Panel</TabsTrigger>
                    </TabsList>
                </Tabs>
                ...
                <AnimatePresence mode='wait'>
                    {state?.error && (
                        <motion.div
                            ...
                            className="mt-10 p-5 bg-secondary/5 border border-secondary/10 text-secondary rounded-2xl text-[10px] font-black uppercase tracking-widest flex items-center gap-4"
                        >
                ...
                <form action={handleSubmit} className="mt-10 space-y-10">
                    <div className="grid md:grid-cols-2 gap-8">
                        <div className="space-y-3">
                            <Label className="text-[10px] font-black text-primary/80 uppercase tracking-[0.2em] pl-1">Full Identity <span className="text-secondary">*</span></Label>
                            <Input
                                name="fullName"
                                type="text"
                                required
                        ...
                        <div className="space-y-3">
                            <Label className="text-[10px] font-black text-primary/80 uppercase tracking-[0.2em] pl-1">Professional Status <span className="text-secondary">*</span></Label>
                            <Input
                                name="designation"
                                type="text"
                                required
                    ...
                    <div className="space-y-3">
                        <Label className="text-[10px] font-black text-primary/80 uppercase tracking-[0.2em] pl-1">Institutional Provenance <span className="text-secondary">*</span></Label>
                        <Input
                            name="institute"
                            type="text"
                            required
                    ...
                    <div className="space-y-3">
                        <div className="flex items-center justify-between pl-1">
                            <Label className="text-[10px] font-black text-primary/80 uppercase tracking-[0.2em]">Transmission Email <span className="text-secondary">*</span></Label>
                        ...
                        <div className="relative">
                            <Input
                                ...
                                className={`h-14 rounded-2xl font-bold transition-all shadow-inner px-6 ${emailStatus.exists
                            ...
                            {emailStatus.exists && (
                                ...
                                >
                                    ...
                                    <span className="text-[9px] font-black uppercase tracking-[0.1em]">Identity already exists in our archives.</span>
                                </motion.div>
                            )}
                        </div>
                    </div>
                    ...
                    <div className="pt-8">
                        ...
                        <p className="text-center mt-6 text-[10px] text-primary/30 font-black uppercase tracking-[0.2em]">
                            {emailStatus.exists
