                ...
                <div className="lg:col-span-2 space-y-12">
                    <section className="relative">
                        ...
                        <p className="text-xl md:text-2xl font-black leading-relaxed text-primary tracking-tight italic">
                            "The IJITEST legal framework is designed to orchestrate a transparent, ethical, and professional ecosystem for the dissemination of engineering excellence."
                        </p>
                    </section>
                    ...
                    <Card className="border-primary/5 shadow-vip hover:shadow-vip-hover transition-all duration-500 rounded-[3rem] bg-white group overflow-hidden relative">
                        ...
                        <CardHeader className="p-10 px-12 border-b border-primary/5 bg-primary/5">
                            <div className="space-y-1">
                                <Badge variant="secondary" className="font-black text-[9px] uppercase tracking-[0.3em] bg-white text-primary px-4 h-6 rounded-full shadow-sm border border-primary/5 italic">Legal Protocol</Badge>
                                <CardTitle className="text-3xl font-black text-primary tracking-tighter italic mt-2">Intellectual <span className="text-secondary not-italic">Sovereignty</span></CardTitle>
                            </div>
                        </CardHeader>
                    ...
                    <section className="pt-10 border-t border-primary/5 space-y-8">
                        <div className="flex items-center gap-6">
                            ...
                            <div>
                                <h2 className="text-3xl font-black text-primary tracking-tighter italic">Conduct & <span className="text-secondary not-italic">Mandate</span></h2>
                                <p className="text-[11px] text-primary/30 font-black uppercase tracking-[0.4em] mt-1 italic">Professional Obligations</p>
                            </div>
                        </div>
                        <div className="space-y-6 text-base font-medium text-primary/40 leading-relaxed italic pl-20 border-l-2 border-primary/5">
                            <p>
                    ...
                    <Card className="bg-primary/5 border-primary/5 rounded-[3rem] shadow-inner group overflow-hidden relative">
                        ...
                        <CardContent className="p-10 sm:p-14 flex flex-col md:flex-row gap-10 items-center relative z-10">
                            ...
                            <div className="space-y-4">
                                <h3 className="text-2xl font-black text-primary tracking-tighter italic">Framework <span className="text-secondary not-italic">Evolution</span></h3>
                ...
                <div className="space-y-10">
                    ...
                    <Card className="bg-primary border-none text-white shadow-vip rounded-[2.5rem] overflow-hidden relative group">
                        ...
                        <CardHeader className="p-8 pb-4">
                            <ShieldAlert className="w-10 h-10 text-secondary/40 mb-4 group-hover:rotate-12 transition-transform" />
                            <CardTitle className="text-2xl font-black text-white tracking-tighter italic">Policy <span className="text-secondary not-italic">Matrix</span></CardTitle>
                        </CardHeader>
                        <CardContent className="p-8 pt-0 space-y-4">
                            <Link href="/privacy" className="flex items-center justify-between p-4 bg-white/5 rounded-2xl border border-white/10 hover:border-white/30 transition-all group/link shadow-inner">
                                <span className="text-[10px] font-black uppercase text-white/40 group-hover/link:text-white transition-colors tracking-widest italic">Privacy Protocol</span>
                            ...
                            <Link href="/guidelines" className="flex items-center justify-between p-4 bg-white/5 rounded-2xl border border-white/10 hover:border-white/30 transition-all group/link shadow-inner">
                                <span className="text-[10px] font-black uppercase text-white/40 group-hover/link:text-white transition-colors tracking-widest italic">Author Guidelines</span>
                                <ChevronRight className="w-4 h-4 text-secondary group-hover/link:translate-x-1 transition-transform" />
                            </Link>
                        </CardContent>
                    </Card>
                    ...
                    <Card className="bg-primary/5 border-primary/5 border-dashed border-2 rounded-[2.5rem] p-8 text-center space-y-6 group overflow-hidden relative">
                        ...
                        <div className="space-y-2 relative z-10">
                            <h4 className="text-xl font-black text-primary tracking-tighter italic">Call for <span className="text-secondary">Papers</span></h4>
                            <p className="text-[11px] text-primary/40 font-black uppercase tracking-widest italic leading-relaxed">Join the 2026 Scientific Cohort</p>
                        </div>
