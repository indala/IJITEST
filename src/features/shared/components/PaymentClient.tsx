    ...
    if (loading) return (
        <div className="min-h-screen flex items-center justify-center bg-background">
            <div className="flex flex-col items-center gap-6">
                ...
                <p className="font-black text-primary/40 uppercase tracking-[0.4em] text-[10px] italic animate-pulse">Authenticating Invoice Session</p>
            </div>
        </div>
    );
            ...
            <Card className="max-w-xl w-full border-primary/5 rounded-[3.5rem] text-center p-12 sm:p-20 shadow-vip bg-white group">
                <CardContent className="space-y-10 p-0">
                    ...
                    <div className="space-y-4">
                        <h2 className="text-3xl font-black text-primary tracking-tighter italic">Invalid <span className="text-destructive not-italic">Credential</span></h2>
                        <p className="text-sm text-primary/40 font-medium italic leading-relaxed">This payment token is either expired or the manuscript is undergoing mandatory verification. Please contact the editorial desk.</p>
                    </div>
        ...
        <div className="min-h-screen flex items-center justify-center bg-background p-4 sm:p-8">
            <Card className="max-w-xl w-full border-primary/5 rounded-[3.5rem] text-center p-12 sm:p-20 shadow-vip-hover bg-white group">
                <CardContent className="space-y-10 p-0">
                    ...
                    <div className="space-y-4">
                        <h2 className="text-3xl font-black text-primary tracking-tighter italic">Grant <span className="text-emerald-500 not-italic">Confirmed</span></h2>
                        <p className="text-sm text-primary/40 font-medium italic leading-relaxed">Transaction finalized. Your research is now officially queued for global indexing and DOI assignment.</p>
                    </div>
                    <div className="space-y-4 pt-4">
                        ...
                        <p className="text-[10px] font-black uppercase tracking-widest text-primary/20 italic">Redirecting in 5 seconds...</p>
                    </div>
                </CardContent>
            </Card>
        </div>
                ...
                <div className="flex flex-col lg:flex-row gap-12 items-start">
                    ...
                    <div className="flex-1 space-y-10">
                        <div className="space-y-6">
                            ...
                            <div>
                                <h1 className="text-4xl md:text-5xl font-black text-primary tracking-tighter uppercase italic leading-none">Manuscript <span className="text-secondary not-italic">Grant</span></h1>
                                <p className="text-[11px] text-primary/30 font-black uppercase tracking-[0.4em] mt-3 flex items-center gap-4 italic font-serif">
                        ...
                        <Card className="border-primary/5 shadow-vip rounded-[3rem] overflow-hidden bg-white group">
                            <CardHeader className="bg-primary/5 border-b border-primary/5 p-8 px-10">
                                <div className="flex justify-between items-center">
                                    <Badge variant="secondary" className="font-black text-[10px] uppercase tracking-[0.3em] bg-white text-primary px-4 h-6 rounded-full shadow-sm border border-primary/5 italic">Invoice Details</Badge>
                                    <ShieldCheck className="w-6 h-6 text-primary/20" />
                                </div>
                            </CardHeader>
                            <CardContent className="p-10 px-12 space-y-10">
                                <div className="space-y-2">
                                    <h3 className="text-2xl font-black text-primary leading-tight tracking-tight italic line-clamp-2">{manuscript.title}</h3>
                                ...
                                <div className="grid grid-cols-2 gap-8 py-8 border-y border-primary/5">
                                    <div className="space-y-1">
                                        <p className="text-[10px] font-black text-primary/30 uppercase tracking-[0.3em] italic">Principal Investigator</p>
                                        <p className="text-base font-black text-primary">{manuscript.author_name}</p>
                                    </div>
                                    <div className="space-y-1">
                                        <p className="text-[10px) font-black text-primary/30 uppercase tracking-[0.3em] italic">Currency</p>
                                        <p className="text-base font-black text-primary">INR (₹) - Indian Rupee</p>
                                    </div>
                                </div>

                                <div className="space-y-5 pt-4">
                                    <div className="flex justify-between items-center text-[11px] font-black uppercase tracking-[0.2em] text-primary/40 italic">
                                    ...
                                    <div className="flex justify-between items-center pt-8 mt-4 border-t-2 border-dashed border-primary/10">
                                        <span className="text-base font-black text-primary uppercase tracking-[0.1em] italic">Grand Total Due</span>
                        ...
                        <div className="bg-primary/5 border border-primary/5 p-8 rounded-[2.5rem] relative overflow-hidden group/policy">
                            ...
                            <div className="flex gap-6 relative z-10">
                                ...
                                <div className="space-y-2">
                                    <h4 className="text-[11px] font-black uppercase tracking-[0.3em] text-primary italic">Financial Policy</h4>
                                    <p className="text-[11px] text-primary/40 font-medium leading-relaxed italic pr-8">
                    ...
                    <div className="w-full lg:w-[380px] lg:sticky lg:top-32">
                        <Card className="border-primary/5 shadow-vip-hover rounded-[3rem] p-10 bg-white space-y-10 group/checkout">
                            <div className="text-center space-y-6">
                                ...
                                <div>
                                    <h2 className="text-2xl font-black text-primary tracking-tighter italic">Secure <span className="text-secondary not-italic">Grant</span></h2>
                                    <p className="text-[11px] text-primary/40 font-black uppercase tracking-[0.3em] mt-2 italic">Standard Gateway Encryption</p>
                                </div>
                            </div>
                            ...
                            >
                                ...
                                {processing ? (
                                    ...
                                    <>
                                        <span className="text-xl font-black tracking-tighter italic">Confirm ₹ 2,500.00</span>
