                    ...
                    <section className="grid grid-cols-1 md:grid-cols-2 gap-6">
                        <Card className="bg-white border-primary/5 shadow-vip hover:shadow-vip-hover transition-all duration-500 rounded-[2.5rem] group overflow-hidden">
                            <CardContent className="p-8">
                                ...
                                <h3 className="text-xl font-black mb-1 text-primary tracking-tighter italic">Editorial <span className="text-secondary not-italic">Nexus</span></h3>
                                <p className="text-2xl font-black text-primary mb-4 tracking-tight italic">editor@ijitest.org</p>
                                <Badge variant="secondary" className="text-[9px] font-black uppercase tracking-[0.3em] bg-primary/5 text-primary/40 border-none px-3 h-6 italic">24/7 Author Synchrony</Badge>
                            </CardContent>
                        </Card>
                        ...
                        <Card className="bg-white border-primary/5 shadow-vip hover:shadow-vip-hover transition-all duration-500 rounded-[2.5rem] group overflow-hidden">
                            <CardContent className="p-8">
                                ...
                                <h3 className="text-xl font-black mb-1 text-primary tracking-tighter italic">WhatsApp <span className="text-secondary not-italic">Hotline</span></h3>
                                <p className="text-2xl font-black text-primary mb-4 tracking-tight italic">+91 8919643590</p>
                                <Badge variant="secondary" className="text-[9px] font-black uppercase tracking-[0.3em] bg-secondary/5 text-secondary border-none px-3 h-6 italic">Immediate Reception</Badge>
                            </CardContent>
                        </Card>
                    </section>
                ...
                <div className="space-y-10">
                    ...
                    <Card className="bg-primary border-none text-white shadow-vip rounded-[3rem] overflow-hidden relative group">
                        ...
                        <CardContent className="p-10">
                            ...
                            <h3 className="text-2xl font-black mb-1 tracking-tighter italic">Editorial <span className="text-secondary not-italic">HQ</span></h3>
                            <p className="text-[10px] font-black text-white/40 uppercase tracking-[0.4em] mb-8 italic">Felix Academic Publications</p>
                            <div className="text-base text-white/60 leading-relaxed font-medium space-y-1 italic">
                    ...
                    <Card className="bg-primary/5 border-primary/5 shadow-vip rounded-[2.5rem] group overflow-hidden relative">
                        ...
                        <CardContent className="p-8 relative z-10">
                            ...
                            <h3 className="text-xl font-black text-primary mb-2 tracking-tighter italic">Integrity <span className="text-secondary not-italic">Nexus</span></h3>
                            <p className="text-[11px] text-primary/40 mb-8 font-black uppercase tracking-widest italic leading-relaxed">COPE Standard Adherence</p>
