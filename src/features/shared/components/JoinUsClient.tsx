            ...
            <div className="grid lg:grid-cols-12 gap-12 lg:gap-20">
                ...
                <div className="lg:col-span-5 space-y-12">
                    <div className="space-y-6">
                        ...
                        <p className="text-primary/70 leading-relaxed font-medium text-lg border-l-4 border-secondary/20 pl-6">
                    ...
                    <div className="grid grid-cols-1 gap-4">
                        {[
                            ...
                            <Card key={i} className="bg-white border-primary/5 shadow-lg hover:shadow-xl transition-all duration-500 rounded-[2.5rem] group overflow-hidden">
                                <CardContent className="p-6 flex gap-6 items-center">
                                    ...
                                    <div>
                                        <h3 className="text-xl font-black text-primary tracking-tight mb-1">{benefit.title}</h3>
                                        <p className="text-primary/60 text-xs font-medium leading-relaxed">{benefit.desc}</p>
                                    </div>
                                </CardContent>
                            </Card>
                        ))}
                    ...
                    <Card className="bg-primary border-none shadow-lg rounded-[2rem] overflow-hidden relative group">
                        ...
                        <CardContent className="p-10">
                            <h3 className="font-black text-3xl mb-8 text-white tracking-tighter">Eligibility Requirements</h3>
                            <ul className="space-y-4">
                                {[
                                    ...
                                    <li key={i} className="flex items-start gap-4 text-[13px] font-black group/item">
                                        <div className="w-6 h-6 bg-white/20 rounded-lg flex items-center justify-center shrink-0 border border-white/30 group-hover:bg-secondary group-hover:border-secondary transition-colors transition-all duration-300">
                                            <CheckCircle2 className="w-3.5 h-3.5 text-white" />
                                        </div>
                                        <span className="text-white font-medium group-hover:text-white transition-colors">{item}</span>
                                    </li>
                                ))}
                            </ul>
                        </CardContent>
