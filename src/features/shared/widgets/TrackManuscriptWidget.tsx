        ...
        <Card className="border-border/50 bg-card rounded-xl shadow-sm transition-all group">
            ...
            <CardContent className="p-5 pt-4">
                <form onSubmit={handleTrack} className="space-y-3">
                    ...
                    />
                    <Button type="submit" className="w-full h-10 bg-[#000066] hover:bg-[#000088] text-white font-bold text-[10px] 2xl:text-xl tracking-wider rounded-lg transition-all shadow-sm uppercase gap-2">
