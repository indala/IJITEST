        ...
        return (
            <Card className="border-sky-200 bg-sky-50/50 dark:bg-sky-950/20 rounded-2xl overflow-hidden animate-in fade-in duration-500 shadow-sm">
                <CardHeader className="pb-3 border-b border-sky-200/50 bg-sky-100/30 dark:bg-sky-900/30">
                    <div className="flex items-center justify-between gap-2">
                        <div className="flex items-center gap-2.5">
                            ...
                            <div>
                                <CardTitle className="font-black uppercase tracking-wider text-sky-900 dark:text-sky-100">
                                    Zenodo Open Archive
                                </CardTitle>
                                <CardDescription className="text-body-sm text-sky-700/80 dark:text-sky-300/80">
                                    CERN / OpenAIRE Open Access Repository
                                </CardDescription>
                            </div>
                        </div>
                        <Badge className="bg-sky-500/15 text-sky-700 dark:text-sky-300 border-sky-300/50 text-badge font-black uppercase tracking-wider flex items-center gap-1">
                ...
                <CardContent className="pt-4 space-y-3">
                    <p className="text-sky-800/80 dark:text-sky-200/80 leading-relaxed">
                    ...
                    {deposit.doi && (
                        <div className="flex items-center justify-between p-2.5 rounded-xl bg-white/70 dark:bg-background/50 border border-sky-200 text-body-sm">
                            <span className="text-sky-900/60 dark:text-sky-300/60 font-mono text-meta font-bold">Zenodo DOI</span>
                            <span className="font-mono font-bold text-sky-700 dark:text-sky-400 text-meta">{deposit.doi}</span>
                        </div>
                    )}
                    ...
                    {deposit.recordUrl && (
                        <Button
                            ...
                            size="sm"
                            variant="outline"
                            className="w-full h-9 gap-2 rounded-xl text-label font-bold uppercase tracking-wider border-sky-300/60 text-sky-700 hover:bg-sky-100 dark:border-sky-800 dark:text-sky-300 dark:hover:bg-sky-950"
                        >
    ...
    return (
        <Card className="border-primary/10 shadow-sm rounded-2xl overflow-hidden bg-muted/5">
            <CardHeader className="pb-3 border-b border-primary/5 bg-primary/2">
                <div className="flex items-center justify-between gap-2">
                    <div className="flex items-center gap-2.5">
                        ...
                        <div>
                            <CardTitle className="font-black uppercase tracking-wider text-primary">
                    ...
                    <Badge variant="outline" className="text-badge font-bold uppercase tracking-wider text-muted-foreground border-primary/10">
                        Optional
                    </Badge>
                </div>
            </CardHeader>
            <CardContent className="pt-4 space-y-3">
                ...
                {publication.doi && (
                    <div className="flex items-center justify-between p-2.5 rounded-xl bg-primary/5 border border-primary/5 text-body-sm">
                        <span className="text-muted-foreground font-mono text-meta font-bold uppercase">Canonical CrossRef DOI</span>
                        <span className="font-mono font-bold text-primary text-meta">{publication.doi}</span>
                    </div>
                )}
                ...
                <Button
                    ...
                    disabled={isPending}
                    variant="outline"
                    className="w-full h-9 gap-2 rounded-xl text-label font-bold uppercase tracking-wider border-primary/20 hover:bg-primary/5 text-primary"
                >
                    {isPending ? (
                        <>
