...
export function ZenodoDepositCard({
    ...
    if (deposit) {
        return (
            <Card className="border-sky-200 bg-sky-50/50 rounded-2xl overflow-hidden animate-in fade-in duration-500 shadow-sm">
                <CardHeader className="pb-3 border-b border-sky-200/50 bg-sky-100/30">
                    <div className="flex items-center justify-between gap-2">
                        <div className="flex items-center gap-2.5">
                            ...
                            <div>
                                <CardTitle className="font-black uppercase tracking-wider text-sky-900">
                                    Zenodo Open Archive
                                </CardTitle>
                                <CardDescription className="text-body-sm text-sky-700/80">
                                    CERN / OpenAIRE Open Access Repository
                                </CardDescription>
                            </div>
                        </div>
                        <Badge className="bg-sky-500/15 text-sky-700 border-sky-300/50 text-badge font-black uppercase tracking-wider flex items-center gap-1">
                ...
                <CardContent className="pt-4 space-y-3">
                    ...
                    {deposit.doi && (
                        <div className="flex items-center justify-between p-2.5 rounded-xl bg-white/70 border border-sky-200 text-body-sm">
                            <span className="text-sky-900/60 font-mono text-meta font-bold">Zenodo DOI</span>
                            <span className="font-mono font-bold text-sky-700 text-meta">{deposit.doi}</span>
                        </div>
                    )}
                    ...
                    {deposit.recordUrl && (
                        <Button
                            ...
                            size="sm"
                            variant="outline"
                            className="w-full h-9 gap-2 rounded-xl text-label font-bold uppercase tracking-wider border-sky-300/60 text-sky-700 hover:bg-sky-100"
                        >
