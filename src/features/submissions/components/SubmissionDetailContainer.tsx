...
export default function SubmissionDetailContainer({ role, submission }: SubmissionDetailContainerProps) {
    ...
    const hasActiveArchive = isPublished && submission.volumeNumber && submission.issueNumber;
    const publicArchiveUrl = hasActiveArchive
        ? `/archives/volume${submission.volumeNumber}/issue${submission.issueNumber}/${submission.paperId}`
        : "/archives";
