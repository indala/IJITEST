                ...
                <div className="p-8 flex flex-col xl:flex-row xl:items-center justify-between gap-8">
                    <div className="flex-1 space-y-4 min-w-0">
                        <div className="flex flex-wrap items-center gap-3">
                            <Badge className={`h-7 px-4 text-badge font-bold border-none rounded-lg ${item.status === 'completed' ? 'bg-emerald-600 text-white' : 'bg-primary text-white'} `}>
                        ...
                        <h3 className="font-semibold text-foreground hover:text-primary transition-colors leading-tight">
                            {item.title}
                        </h3>
                        ...
                        <div className="flex flex-wrap gap-8 items-center pt-2">
                            ...
                            <div className="flex items-center gap-2 text-body-sm font-bold text-amber-700 bg-amber-50 px-3 py-1.5 rounded-xl border border-amber-200">
                        ...
                        {item.commentsToAuthor && (
                            <div className="mt-6 p-6 bg-muted/30 rounded-2xl border-l-4 border-l-primary text-caption text-foreground leading-relaxed italic">
                                &quot;{item.commentsToAuthor}&quot;
                            </div>
                        )}
                        ...
                        {item.status === 'completed' && (
                            <div className="flex flex-wrap items-center gap-3 pt-3 mt-2 border-t border-border/40">
                                <span className="text-caption font-semibold text-muted-foreground">Editor Rating:</span>
                                ...
                                {currentRating ? (
                                    <span className="text-badge font-bold text-amber-600 bg-amber-500/10 px-2 py-0.5 rounded-full border border-amber-500/20">
                    ...
                    <div className="shrink-0 flex flex-col gap-4 xl:w-72 border-t xl:border-t-0 pt-8 xl:pt-0 border-border/50">
                        <div className="flex flex-col gap-2 w-full">
                            {item.manuscriptPath && (
                                <Button asChild className="w-full h-10 gap-3 font-bold rounded-xl bg-primary text-white hover:scale-[1.02] transition-all cursor-pointer">
                            ...
                            {item.feedbackFilePath && (
                                <Button asChild variant="outline" className="w-full h-12 gap-3 font-bold uppercase tracking-widest rounded-xl border-emerald-600 text-emerald-600 bg-emerald-50 hover:bg-emerald-100 transition-all cursor-pointer">
                            ...
                            {isReviewer && (
                                <Button asChild variant="outline" className="flex-1 h-12 gap-2 font-semibold uppercase tracking-widest rounded-xl border-primary/10 text-primary transition-all shadow-sm cursor-pointer">
                        ...
                        {item.status !== 'completed' && isReviewer && (
                            <Dialog onOpenChange={(open) => !open && setFeedbackFile(null)}>
                                <DialogTrigger asChild>
                                    <Button className="w-full h-12 gap-3 font-semibold shadow-lg rounded-xl bg-primary text-white transition-all cursor-pointer">
                                ...
                                <DialogContent className="sm:max-w-3xl rounded-xl p-6 bg-card border-border shadow-2xl">
                                    <DialogHeader className="space-y-1">
                                        <DialogTitle className="font-bold text-primary tracking-tight">Review Details</DialogTitle>
                                    ...
                                    <form action={handleFormSubmit} className="space-y-5 pt-2">
                                        <div className="grid grid-cols-1 md:grid-cols-2 gap-5">
                                            ...
                                            <div className="space-y-4">
                                                <div className="space-y-1.5">
                                                    <label className="form-label-brand font-medium text-muted-foreground">recommendation</label>
                                                    <Select name="decision" required>
                                                        <SelectTrigger className="h-11 bg-muted/30 border-border/50 rounded-lg px-4">
                                                ...
                                                <div className="space-y-3 p-3 bg-muted/20 rounded-xl border border-border/60">
                                                    <p className="text-label font-bold uppercase tracking-wider text-muted-foreground">Evaluation Rubric (1-5)</p>
                                                    <div className="grid grid-cols-2 gap-3">
                                                        <div className="space-y-1">
                                                            <label className="form-label-brand font-medium text-muted-foreground">Originality & Novelty</label>
                                                        ...
                                                        <div className="space-y-1">
                                                            <label className="form-label-brand font-medium text-muted-foreground">Technical Methodology</label>
                                                        ...
                                                        <div className="space-y-1">
                                                            <label className="form-label-brand font-medium text-muted-foreground">Clarity & Organization</label>
                                                        ...
                                                        <div className="space-y-1">
                                                            <label className="form-label-brand font-medium text-muted-foreground">Literature Review</label>
                                                ...
                                                <div className="grid grid-cols-2 gap-3">
                                                    <div className="space-y-1.5">
                                                        ...
                                                        <Input
                                                            ...
                                                            defaultValue="8"
                                                            placeholder="8"
                                                            className="h-10 bg-muted/30 border-border/50 rounded-lg px-3 text-body-sm"
                                                        />
                                                    </div>
                                                    <div className="space-y-1.5">
                                            ...
                                            <div className="space-y-4">
                                                <div className="space-y-1.5">
                                                    ...
                                                    <Textarea
                                                        ...
                                                        required
                                                        rows={5}
                                                        className="w-full bg-muted/30 border-border/50 rounded-lg p-3 text-body-sm text-foreground resize-none"
                                                        ...
                                                        <div className="flex items-center justify-center pointer-events-none space-x-3">
                                                            {feedbackFile ? (
                                                                <>
                                                                    ...
                                                                    <p className="font-medium text-emerald-600 truncate max-w-[140px]">{feedbackFile.name}</p>
                                                                </>
                                                            ) : (
                                                                <>
                                                                    <FileUp className="w-4 h-4 text-primary/40 group-hover:scale-110 transition-all" />
                                                                    <p className="font-medium text-primary/60">select assessment pdf</p>
                                                                </>
                                                            )}
                                                        </div>
                                                    </div>
                                        ...
                                        <DialogFooter className="pt-2 border-t border-border/50">
                                            <Button type="submit" disabled={isPending} className="w-full h-12 bg-primary text-white font-bold rounded-lg transition-all cursor-pointer">
                        ...
                        {item.status === 'completed' && isInternalStaff && !['accepted', 'rejected', 'published', 'paid'].includes(item.submissionStatus) && (
                            <div className="grid grid-cols-2 gap-3 mt-4 pt-6 border-t border-primary/5">
                                <Button
                                    ...
                                    className="h-12 bg-emerald-600 hover:bg-emerald-700 text-white font-semibold text-label uppercase tracking-widest rounded-xl transition-all"
                                >
                                ...
                                <Button
                                    ...
                                    className="h-12 font-semibold text-label uppercase tracking-widest border-rose-500/20 text-rose-600 bg-rose-500/5 hover:bg-rose-500/10 rounded-xl transition-all"
                                >
