...
export default function PublisherSection({ settings, embedded = false }: PublisherSectionProps) {
    ...
    return (
        <section className={embedded
            ? "relative overflow-hidden border-t border-primary/10 pt-5 sm:pt-6"
            : "section-vertical bg-background relative overflow-hidden border-t border-primary/5 my-2"
        }>
            {!embedded && (
            ...
            <div className={embedded
                ? "relative z-10"
                : "container-responsive text-center sm:text-left relative z-10"
            }>
