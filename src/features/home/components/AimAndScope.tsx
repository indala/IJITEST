...
function AimAndScope({ journalShortName }: { journalShortName?: string }) {
    ...
    return (
        <div className="space-y-12">
                    ...
                    <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                        {disciplines.map((item, i) => (
                            <motion.div
                                ...
                                className="flex items-center justify-between p-4 bg-white rounded-2xl border border-primary/5 shadow-vip hover:shadow-vip-hover hover:border-secondary/20 transition-all duration-500 group"
                            >
            ...
            {/* Publication Process */}
            <section className="bg-primary p-10 rounded-[3rem] text-white overflow-hidden relative shadow-vip border border-white/5">
                <div className="absolute top-0 right-0 w-80 h-80 bg-secondary opacity-20 rounded-full blur-[100px] -translate-y-1/2 translate-x-1/2 animate-pulse" />
                <div className="absolute -bottom-20 -left-20 w-60 h-60 bg-accent opacity-20 rounded-full blur-[80px]" />

                <div className="relative z-10 flex flex-col md:flex-row items-center gap-12">
                    <div className="w-28 h-28 bg-white/10 backdrop-blur-md rounded-[2rem] flex items-center justify-center shrink-0 border border-white/20 hover:rotate-6 transition-transform duration-500">
