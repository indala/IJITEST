    ...
    return (
        <div className="min-h-[60vh] flex flex-col items-center justify-center p-8 text-center bg-white rounded-xl border border-gray-100 shadow-sm mx-auto">
            ...
            <div className="flex flex-col sm:flex-row gap-4">
                <button
                    onClick={() => reset()}
                    className="flex items-center justify-center gap-3 px-8 py-4 bg-primary text-white rounded-xl font-black uppercase tracking-widest hover:bg-primary/95 transition-all shadow-lg shadow-primary/20 cursor-pointer"
                >
                    <RotateCcw className="w-4 h-4" /> Retry Operation
                </button>
                <Link
                    href={dashboardUrl}
                    className="flex items-center justify-center gap-3 px-8 py-4 bg-primary/5 text-primary rounded-xl font-black uppercase tracking-widest hover:bg-primary/20 transition-all border border-primary/10 cursor-pointer"
                >
