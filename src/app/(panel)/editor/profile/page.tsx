    ...
    return (
        <section className="space-y-4">
            <header className="space-y-1 border-b border-border/70 pb-3 sm:pb-4">
                <h1 className="panel-title font-bold text-primary">Editorial Identity</h1>
            ...
            <Suspense fallback={
                <div className="h-96 flex flex-col items-center justify-center gap-4 text-muted-foreground">
                    ...
                    <p className="text-label font-semibold capitalize tracking-widest animate-pulse">Decrypting board credentials...</p>
                </div>
            }>
