    ...
    return (
        <DropdownMenu>
            <DropdownMenuTrigger asChild>
                <Button variant="ghost" className="h-14 xl:h-16 2xl:h-24 px-3 xl:px-4 2xl:px-8 gap-3 xl:gap-4 2xl:gap-8 hover:bg-muted rounded-xl 2xl:rounded-4xl outline-none transition-all group cursor-pointer">
            ...
            <DropdownMenuContent align="end" className="w-64 2xl:w-96 rounded-xl 2xl:rounded-3xl p-2 2xl:p-4 shadow-2xl border-primary/5">
