    ...
    return (
        <section className="space-y-4">
            <header className="space-y-1 border-b border-border/70 pb-3 sm:pb-4">
                <h1 className="panel-title font-bold text-primary">Review Board Profile</h1>
            ...
            <Suspense fallback={
                <div className="h-96 flex flex-col items-center justify-center gap-4 text-muted-foreground">
                    ...
                    <p className="font-mono text-meta uppercase tracking-widest animate-pulse">Decrypting Identity Archive...</p>
                </div>
            }>
