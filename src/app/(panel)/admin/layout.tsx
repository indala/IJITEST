...
const sidebarItems = [
    { name: 'Dashboard', icon: <LayoutDashboard />, href: '/admin', roles: ['admin', 'editor', 'reviewer'] },
    { name: 'Submissions', icon: <FileStack />, href: '/admin/submissions', roles: ['admin', 'editor'] },
    { name: 'Peer Review', icon: <ShieldAlert />, href: '/admin/reviews', roles: ['admin', 'editor', 'reviewer'] },
    { name: 'Volumes & Issues', icon: <BookOpen />, href: '/admin/publications', roles: ['admin', 'editor'] },
    { name: 'Payments', icon: <CreditCard />, href: '/admin/payments', roles: ['admin'] },
    { name: 'Messages', icon: <MessageSquare />, href: '/admin/messages', roles: ['admin', 'editor'] },
    { name: 'Users & Roles', icon: <Users />, href: '/admin/users', roles: ['admin'] },
    { name: 'System Settings', icon: <Settings />, href: '/admin/settings', roles: ['admin'] },
];
            ...
            <main className="flex-1 min-h-screen">
                <header className="bg-white/80 backdrop-blur-md border-b border-gray-100 flex items-center justify-between px-10 h-24 sticky top-0 z-10">
                    ...
                    <div className="flex items-center gap-6">
                        ...
                        <div className="w-12 h-12 rounded-2xl bg-primary/10 flex items-center justify-center border-2 border-white shadow-sm overflow-hidden text-primary font-black">
