    ...
    return (
        <div className="space-y-6 pb-20">
            ...
            <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-4">
                <div>
                    <h1 className="text-xl font-black text-foreground tracking-tight whitespace-nowrap">Manage Applications</h1>
                    <p className="text-xs font-medium text-muted-foreground">Review Reviewer and Editorial Board join requests.</p>
                </div>
            ...
            <Card className="border-border/50 shadow-sm overflow-hidden bg-muted/10">
                <CardContent className="p-4 flex flex-col md:flex-row gap-4 items-center">
                    ...
                    <div className="flex items-center gap-2 px-3 py-1.5 bg-background rounded-lg border border-border/50 shrink-0">
                        ...
                        <span className="text-[10px] font-black text-muted-foreground uppercase tracking-widest">{filteredApps.length} Pending Records</span>
                    </div>
                </CardContent>
            </Card>
            ...
            <div className="grid grid-cols-1 gap-4">
                {loading ? (
                    <div className="py-20 flex flex-col items-center justify-center gap-4 text-muted-foreground">
                        ...
                        <p className="font-black text-[10px] uppercase tracking-[0.2em] animate-pulse italic">Scanning Applications...</p>
                    </div>
                    ...
                    <div className="flex flex-col items-center justify-center py-20 bg-muted/20 border border-dashed border-border/50 rounded-2xl">
                        ...
                        <p className="text-[10px] font-black text-muted-foreground uppercase tracking-[0.2em] italic">No join requests found</p>
                    </div>
                ) : (
