...
import { generateDoajXml } from "@/lib/doaj-generator";
    ...
    try {
        ...
        return new NextResponse(xml, {
            ...
            headers: {
                ...
                "Content-Disposition": `attachment; filename="doaj-issue-vol${issue.volumeNumber}-iss${issue.issueNumber}.xml"`,
                "Cache-Control": "public, max-age=3600",
            },
        });
    } catch (error) {
        console.error("DOAJ issue export error:", error);
