                    ...
                    <div className="lg:col-span-2 space-y-12">
                        <Tabs defaultValue="workflow" className="w-full">
                                                ...
                                                <CardContent className="p-7">
                                                    <div className="flex gap-5">
                                                        ...
                                                        <div className="space-y-2">
                                                            ...
                                                            <p className="text-[11px] text-primary/60 font-medium leading-relaxed italic">{step.desc}</p>
                                                        </div>
                                                    </div>
                                                </CardContent>
                                            </Card>
                                ...
                                <Card className="bg-primary p-1 rounded-[3rem] shadow-vip border-none overflow-hidden group">
                                    <div className="bg-white/5 backdrop-blur-md p-8 sm:p-10 rounded-[2.8rem] relative">
                                        ...
                                        <div className="flex flex-col md:flex-row md:items-center justify-between gap-8 relative z-10">
                                            <div className="space-y-2">
                                                <h3 className="text-2xl font-black text-white tracking-tighter italic">Ready for <span className="text-secondary not-italic">Submission?</span></h3>
                                                <p className="text-sm text-white/60 font-medium italic border-l-2 border-white/10 pl-6">"Elite research deserves elite recognition. Submit your technical breakthrough today."</p>
                                            </div>
                            ...
                            <TabsContent value="preparation" className="space-y-8 mt-0 animate-in fade-in slide-in-from-bottom-2 duration-500">
                                <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                                    <Card className="bg-white border border-primary/5 shadow-vip rounded-[2.5rem] overflow-hidden">
                                        <CardHeader className="p-8 pb-4">
                                            <CardTitle className="text-xl font-black text-primary flex items-center gap-3 tracking-tighter italic">
                                                <Info className="w-6 h-6 text-secondary" /> Formatting <span className="text-secondary not-italic">Standards</span>
                                            </CardTitle>
                                        </CardHeader>
                                        ...
                                        <Button asChild variant="outline" className="w-full h-20 justify-between border-2 border-primary/10 border-dashed px-6 group rounded-[2rem] hover:border-primary/30 hover:bg-primary/5 transition-all outline-none">
                                            <a href={settings.template_url || "/docs/template.docx"} download className="flex items-center gap-5 w-full">
                                                ...
                                                <div className="text-left flex-1">
                                                    ...
                                                    <p className="text-[10px] text-primary/40 font-black uppercase italic">IEEE Standard</p>
                                                </div>
                                        ...
                                        <Button asChild variant="outline" className="w-full h-20 justify-between border-2 border-secondary/10 border-dashed px-6 group rounded-[2rem] hover:border-secondary/30 hover:bg-secondary/5 transition-all outline-none">
                                            <a href={settings.copyright_url || "/docs/copyright-form.pdf"} download className="flex items-center gap-5 w-full">
                                                ...
                                                <div className="text-left flex-1">
                                                    ...
                                                    <p className="text-[10px] text-secondary/40 font-black uppercase italic">Mandatory Doc</p>
                                                </div>
                                ...
                                <Card className="bg-gradient-to-br from-primary/5 to-transparent border border-primary/10 rounded-[2.5rem] shadow-sm italic">
                        ...
                        <section className="pt-12 border-t border-primary/10">
                            <h2 className="text-3xl font-black text-primary mb-10 tracking-widest flex items-center gap-5 italic uppercase">
                                ...
                                {[
                                    ...
                                    <Card key={i} className="bg-white border border-primary/5 shadow-vip hover:shadow-vip-hover hover:border-secondary/20 transition-all duration-500 rounded-3xl overflow-hidden group">
                                        <CardContent className="p-7 text-center space-y-4">
                                            ...
                                            <h4 className="text-base font-black text-primary tracking-tight group-hover:text-secondary transition-colors italic">{item.title}</h4>
                        ...
                        <Card className="bg-primary p-1 border-none text-white shadow-vip rounded-[2.5rem] overflow-hidden relative group">
                            <div className="bg-white/5 backdrop-blur-md p-8 rounded-[2.3rem] relative">
                                ...
                                <CardContent className="p-0 relative z-10">
                                    <h3 className="text-lg font-black mb-6 tracking-widest uppercase text-secondary italic">APC <span className="text-white not-italic">Summary</span></h3>
