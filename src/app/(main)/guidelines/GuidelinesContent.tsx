    ...
    return (
        <div className="bg-white">
            <PageHeader
                ...
                description={`Comprehensive instructions for preparing, submitting, and publishing your technical research with ${shortName}.`}
                breadcrumbs={[
                    { name: 'Home', href: '/' },
                ...
                <div className="grid grid-cols-1 lg:grid-cols-3 gap-16">
                    ...
                    <div className="lg:col-span-2 space-y-20">
                        <section>
                            ...
                            <div className="prose prose-lg max-w-none text-gray-600 space-y-6 font-medium">
                                <p>Authors are requested to follow the standardized {shortName} formatting to ensure rapid processing and global indexing compatibility.</p>
                                ...
                                <div className="bg-gray-50 p-10 rounded-[3rem] border border-gray-100 space-y-8">
                                    <div className="flex flex-col md:flex-row md:items-center justify-between gap-6">
                                        <div>
                                            ...
                                            <p className="text-2xl font-black text-primary">{supportEmail}</p>
                                        </div>
                                        <a href={`mailto:${supportEmail}`} className="bg-white text-gray-900 border-2 border-gray-100 px-10 py-4 rounded-2xl font-black text-xs uppercase tracking-widest shadow-sm hover:border-primary hover:text-primary transition-all text-center">
                                            Send Manuscript
                                        </a>
                                    </div>
                    ...
                    <div className="space-y-10">
                        ...
                        <div className="bg-secondary p-8 rounded-[2.5rem] text-white shadow-xl shadow-secondary/20 group">
                            ...
                            <p className="text-xs text-white/70 mb-8 font-medium leading-relaxed italic">{shortName} follows COPE (Committee on Publication Ethics) guidelines for all research contributions.</p>
                        ...
                        <div className="bg-gray-900 p-8 rounded-[2.5rem] text-white overflow-hidden relative">
                            ...
                            <div className="space-y-4 mb-8">
                                <div className="flex justify-between items-center text-sm">
                                    <span className="opacity-50 font-bold uppercase text-[9px] tracking-widest">Indian Authors (INR)</span>
                                    <span className="font-black text-secondary">₹{settings.apc_inr}</span>
                                </div>
                                <div className="flex justify-between items-center text-sm">
                                    <span className="opacity-50 font-bold uppercase text-[9px] tracking-widest">International Authors (USD)</span>
                                    <span className="font-black text-secondary">${settings.apc_usd}</span>
                                </div>
                            </div>
                            <p className="text-[9px] text-white/30 italic font-medium leading-relaxed">
                                * Fees include DOI assignment and lifetime archiving. Values are managed via Admin Settings.
                            </p>
                        </div>
                    </div>
                </div>
