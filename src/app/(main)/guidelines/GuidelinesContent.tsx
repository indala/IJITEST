        ...
        },
        {
            ...
            content: (
                <div className="space-y-6 sm:space-y-7">
                    <div>
                        <h3 className="text-foreground font-semibold mb-2">1. Text and Type Area (Margins)</h3>
                    ...
                    <div>
                        <h3 className="text-foreground font-semibold mb-2">2. Titles Format</h3>
                    ...
                    <div>
                        <h3 className="text-foreground font-semibold mb-2">3. Text</h3>
                    ...
                    <div>
                        <h3 className="text-foreground font-semibold mb-2">4. Heads / Sub Heads</h3>
                    ...
                    <div>
                        <h3 className="text-foreground font-semibold mb-2">5. Figures and Tables</h3>
                    ...
                    <div>
                        <h3 className="text-foreground font-semibold mb-2">6. References</h3>
                        <p className="mb-2">References text type should be 10 point (Times Roman) at the end of the paper. Format as follows:</p>
                        <div className="space-y-2 bg-primary/5 p-3.5 rounded-xl border border-primary/10 font-mono text-meta overflow-x-auto">
                    ...
                    <div className="relative z-10 space-y-2 text-center">
                        ...
                        <div className="pt-1">
                            <a
                                ...
                                className="text-rose-300 hover:text-white transition-colors font-bold inline-block"
                            >
                                {supportEmail}
                            </a>
                        </div>
