        ...
        <div className="min-h-screen bg-gray-50 flex items-center justify-center p-4">
            ...
            >
                <div className="text-center mb-10">
                    ...
                    <h1 className="text-3xl font-serif font-black text-gray-900 mb-2">Admin Portal</h1>
                ...
                <div className="bg-white p-10 rounded-[2.5rem] shadow-xl shadow-gray-200/50 border border-gray-100">
                    <form className="space-y-6">
                        ...
                        <button className="w-full bg-primary text-white py-4 rounded-2xl font-black text-lg shadow-lg shadow-primary/20 hover:shadow-xl hover:bg-primary/95 transition-all flex items-center justify-center gap-3">
                            Proceed to Dashboard <ShieldCheck className="w-6 h-6" />
                        </button>
                    </form>
                </div>
