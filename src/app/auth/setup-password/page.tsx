    ...
    if (!token || !info) return (
        <div className="min-h-screen bg-gray-50 flex items-center justify-center p-6 text-center">
            <div className="max-w-md w-full bg-white rounded-[2.5rem] p-12 shadow-xl border border-gray-100">
                ...
                <h1 className="text-2xl font-serif font-black text-gray-900 mb-4">Invalid or Expired Link</h1>
                ...
                <Link href="/" className="bg-primary text-white block py-4 rounded-2xl font-black shadow-lg shadow-primary/20">
                    Back to Home
                </Link>
            </div>
        </div>
