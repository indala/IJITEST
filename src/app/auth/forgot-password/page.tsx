        ...
        <div className="min-h-screen bg-gray-50 flex items-center justify-center p-4">
            ...
            >
                <div className="text-center mb-10">
                    ...
                    <h1 className="text-3xl font-serif font-black text-gray-900 mb-2">Password Recovery</h1>
                    <p className="text-gray-500 font-medium italic">Enter your email to receive a reset link</p>
                </div>
                    ...
                    <AnimatePresence mode="wait">
                        {status === 'success' ? (
                            ...
                            >
                                ...
                                <h3 className="text-2xl font-serif font-black text-gray-900 mb-3">Check Your Email</h3>
                            ...
                            >
                                ...
                                <form onSubmit={handleSubmit} className="space-y-6">
                                    <div>
                                        <label className="block text-[10px] font-black text-slate-700 uppercase tracking-widest mb-3 pl-1">Registred Email</label>
                                    ...
                                    <button
                                        ...
                                        className="w-full bg-primary text-white py-5 rounded-[1.5rem] font-black text-xs uppercase tracking-[0.2em] shadow-xl shadow-primary/20 hover:shadow-2xl hover:bg-primary/95 transition-all flex items-center justify-center gap-3 disabled:opacity-50"
                                    >
                                    ...
                                    <div className="text-center">
                                        <Link href="/login" className="text-[10px] font-black uppercase text-gray-400 tracking-widest hover:text-primary transition-colors">
                                            Wait, I remember it!
                                        </Link>
                                    </div>
                                </form>
