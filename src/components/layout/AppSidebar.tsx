...
export function AppSidebar({ settings }: { settings?: Record<string, string> }) {
    ...
    return (
        <Sidebar collapsible="icon" className="border-r border-primary/5 bg-white/50 backdrop-blur-xl">
            <SidebarHeader className="h-20 flex items-center justify-center border-b border-primary/5">
                <Link href="/" className="flex items-center gap-3 group px-4">
                    ...
                    <div className="flex flex-col group-data-[collapsible=icon]:hidden">
                        ...
                        <span className="text-[10px] font-bold text-primary/40 uppercase tracking-tight">
                            Journal Portal
                        </span>
                    </div>
                </Link>
            ...
            <SidebarContent className="px-2">
                <SidebarGroup>
                    <SidebarGroupLabel className="px-4 text-[10px] font-black uppercase tracking-[0.2em] text-primary/30 mt-4">
                        Navigation
                    </SidebarGroupLabel>
                    <SidebarGroupContent>
                        <SidebarMenu>
            ...
            <SidebarFooter className="p-4 border-t border-primary/5">
                <Link
                    href="/submit"
                    className="flex items-center justify-center gap-3 w-full h-12 bg-primary text-white rounded-xl font-black uppercase tracking-widest text-[10px] shadow-xl shadow-primary/20 hover:scale-[1.02] transition-all group overflow-hidden relative"
                >
