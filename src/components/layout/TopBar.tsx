...
export default function TopBar({ settings }: { settings?: Record<string, string> }) {
    ...
    return (
        <div className="bg-primary text-white py-8 px-4 sm:px-6 lg:px-8 border-b border-white/5 relative overflow-hidden">
            ...
            <div className="max-w-[1600px] mx-auto relative z-10 flex flex-col lg:flex-row items-center justify-between gap-6">
                ...
                <div className="flex flex-col items-center lg:items-start space-y-3 text-center lg:text-left max-w-4xl">
                    <div className="space-y-1.5">
                        <h1 className="text-xl sm:text-2xl lg:text-4xl font-sans font-black tracking-tight text-white leading-[1.1] uppercase">
                            {journalName}
                        </h1>
                        <p className="text-[10px] md:text-xs font-bold text-secondary tracking-[0.3em] uppercase opacity-90">
                ...
                <div className="flex flex-col items-center lg:items-end gap-3 lg:text-right shrink-0">
                    ...
                    <div className="flex items-center gap-4">
                        <div className="px-3 py-1 rounded-full bg-emerald-500/10 border border-emerald-500/20 text-[9px] font-black text-emerald-400 uppercase tracking-widest flex items-center gap-2">
